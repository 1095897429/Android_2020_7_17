package com.liangzai.myjavaapplication.net.util;
...
public class HttpUtils {
    ...
    public HttpUtils(String url, String stringParams, IHttpCallback callback) {
        ...
        // 判断是http请求还是https请求
        try {
            java.net.URL httpUrl = new java.net.URL(mUrl);
    ...
    class HttpTask extends AsyncTask<String, Void, String> {
        ...
        public HttpTask(IHttpCallback callback, HttpUtils.HTTP_TYPE type, HttpUtils.PROTOCOL_TYPE protocolType, String params) {
         ...
         javax.net.ssl.TrustManager[] xtmArray = new MytmArray[] { new MytmArray() };
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                ...
                java.net.URL httpUrl = new java.net.URL(urls[0]);
