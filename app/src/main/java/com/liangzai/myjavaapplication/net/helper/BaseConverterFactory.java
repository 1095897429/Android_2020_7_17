...
public class BaseConverterFactory extends Converter.Factory {
    ...
    @Override
    public Converter<ResponseBody, ?> responseBodyConverter(java.lang.reflect.Type type, java.lang.annotation.Annotation[] parameterAnnotations, Retrofit retrofit) {
    ...
    @Override
    public Converter<?, RequestBody> requestBodyConverter(java.lang.reflect.Type type,
