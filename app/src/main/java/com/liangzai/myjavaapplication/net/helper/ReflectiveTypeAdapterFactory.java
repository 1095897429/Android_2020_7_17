...
class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private java.util.List<String> getFieldNames(Field f) {
        return getFieldName(fieldNamingPolicy, f);
    }

    static java.util.List<String> getFieldName(FieldNamingStrategy fieldNamingPolicy, Field f) {
        SerializedName serializedName = f.getAnnotation(SerializedName.class);
        java.util.List<String> fieldNames = new LinkedList<String>();
    ...
    public <T> TypeAdapter<T> create(Gson gson, final TypeToken<T> type) {
        ...
        typeTokens.add(java.sql.Time.class);
...
//                t.write(writer, fieldValue);
    ...
    private java.util.Map<String, BoundField> getBoundFields(Gson context, TypeToken<?> type, Class<?> raw) {
        java.util.Map<String, BoundField> result = new LinkedHashMap<>();
        if (raw.isInterface()) {
            return result;
        }

        java.lang.reflect.Type declaredType = type.getType();
        while (raw != Object.class) {
            ...
            for (Field field : fields) {
                ...
                java.lang.reflect.Type fieldType = $Gson$Types.resolve(type.getType(), raw, field.getGenericType());
                java.util.List<String> fieldNames = getFieldNames(field);
    ...
    public static final class Adapter<T> extends TypeAdapter<T> {
        ...
        private final java.util.Map<String, BoundField> boundFields;

        Adapter(ObjectConstructor<T> constructor, java.util.Map<String, BoundField> boundFields) {
